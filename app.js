...
var budgetController = (function() {
  ...
  return {
    ...
    calculateBudget: function() {
      ...
      //calculate the percentage o0f income thet we setupEventListeners
...
var UIController = (function() {
  ...
  var formatNumber = function(num, type){
    ...
    comma separating the thousands.... 2310.4567 --> + 2,310.46
    */
  ...
  return {
    ...
    displayPercentages: function(percentages){
      var fields = document.querySelectorAll(DOMstrigs.expensesPercLabel);
    ...
    displayMonth: function(){
      ...
      now =new Date();
      months =['January', 'Feb', 'March','April','May','June','July','Aug','Sep','Oct','Nov','December']
      month = now.getMonth();
